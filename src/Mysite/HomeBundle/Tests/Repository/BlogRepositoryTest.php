<?php
// src/Mysite/HomeBundle/Tests/Repository/BlogRepositoryTest.php

namespace Mysite\HomeBundle\Tests\Repository;

use Mysite\HomeBundle\Repository\BlogRepository;
use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class BlogRepositoryTest extends WebTestCase
{
    /**
     * @var \Mysite\HomeBundle\Repository\BlogRepository
     */
    ...
    public function setUp()
    {
        ...
        $this->blogRepository = $kernel->getContainer()
                                       ...
                                       ->getRepository('MysiteHomeBundle:Blog');
    }
